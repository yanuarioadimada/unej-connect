            ...
            <div class="row">
                ...
                <div class="col-sm-4 offset-md-1 py-4 text-right">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="index.php" class="text-white">Beranda</a><i class="fas fa-home ml-2"></i></a></li>
                        <li><a href="#" id="sign-out-link" class="text-white">Log out<i class="fas fa-sign-out-alt ml-2"></i></a></li>
                    </ul>
                    <?php } else { ?>
                    <h4>
                        <a class="text-white" href="sign-in.php">Login</a> <span class="text-white">or</span>
                        <a href="register.php" class="text-white">Daftar</a>
                    </h4>
                    <p class="text-muted">Login agar anda dapat mengakses fitur</p>
                    <?php } ?>
                </div>
            </div>
        </div>
...
<main role="main">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-primary o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5"><?php echo $totalReservations; ?> Reservasi Gedung</div>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-warning o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5"><?php echo $totalCustomers; ?> Akun Pengguna</div>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-success o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-4"><?php echo $confirmedReservation; ?> Reservasi Terkonfirmasi</div>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-danger o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5"><?php echo $pendingReservation; ?> Reservasi Tertunda</div>
                    </div>
                    <div class="card-footer text-white clearfix small z-1"></div>
                </div>
            </div>
        ...
        <ul class="nav nav-tabs" id="adminTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="reservation-tab" data-toggle="tab" href="#reservation" role="tab"
                   aria-controls="reservation" aria-selected="true">Reservasi</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="customers-tab" data-toggle="tab" href="#customers" role="tab"
                   aria-controls="customers" aria-selected="false">Pengguna</a>
            </li>
        </ul>
        <div class="tab-content py-3" id="adminTabContent">
            <div class="tab-pane fade show active" id="reservation" role="tabpanel" aria-labelledby="reservation-tab">
                ...
                <div class="my-3">
                    <div class="row">
                        <div class="col-6">
                            <label class="text-secondary font-weight-bold">yang dipilih: </label>
                            <button type="button" id="confirm-booking" class="btn btn-outline-success btn-sm">Konfirmasi
                            </button>
                            <button type="button" id="cancel-booking" class="btn btn-outline-danger btn-sm">Batal
                            </button>
                        </div>
                        <div class="col-6 text-right">
                            Lihat:
                            <input type="radio" name="viewOption" value="confirmed">&nbsp;Telah dikonfirmasi&nbsp;
                            <input type="radio" name="viewOption" value="pending">&nbsp;Tertunda
                            <input type="radio" name="viewOption" value="all">&nbsp;Semua
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Konfirmasi Reservasi Yang Dipilih</h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="confirmTrue">Iya</button>
    ...
    <div class="modal fade" id="cancelModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Batalkan reservasi yang terpilih</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="cancelTrue">Iya</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                </div>
            </div>
        </div>
